"""
Forsaken Bot — Ticket System (discord.py 2.6+)
...
SUPPORT_ROLE_ID = 1510455933371940867

# ─── Channel IDs ─────────────────────────────────────────────────────────────
LOGS_CHANNEL_ID = 1510458844524974233
...
def build_panel_view() -> ui.LayoutView:
    ...
    view.add_item(ui.Container(
        ui.TextDisplay("## Forsaken Bot — Ticket System"),
        ...
        super().__init__(
            ...
            options=[
                discord.SelectOption(label="Purchase", value="purchase",
                    description="Open a ticket to buy something from Forsaken."),
...
class TicketsCog(commands.Cog):
    ...
    # ── /ticketpanel ─────────────────────────────────────────────────────────
    @app_commands.command(name="ticketpanel", description="Send the Forsaken Bot ticket panel.")
